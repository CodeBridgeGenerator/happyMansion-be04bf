...
const SingleBrandPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("brand")
            .get(urlParams.singleBrandId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>brand/{urlParams.singleBrandId}</p> */}
            </div>
    ...
    <div className="col-12 mt-2">
      ...
      <CommentsSection
        recordId={urlParams.singleBrandId}
        user={props.user}
        alert={props.alert}
        serviceName="brand"
      />
...
export default connect(mapState, mapDispatch)(SingleBrandPage);
