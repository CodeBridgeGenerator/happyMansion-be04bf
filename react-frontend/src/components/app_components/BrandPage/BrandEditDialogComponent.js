...
const BrandEditDialogComponent = (props) => {
...
company: _entity?.company?._id,
        ...
        await client.service("brand").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info brand updated successfully" });
    ...
    return (
        <Dialog header="Edit Brand" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="brand-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(BrandEditDialogComponent);
